 ...
 */
import type { EndPomodoroSessionRequestStatus } from './endPomodoroSessionRequestStatus';

export interface EndPomodoroSessionRequest {
    status: EndPomodoroSessionRequestStatus;
    /** 실제 경과 시간 (초) */
    actual_sec: number;
    ended_at: string;
}
