 ...
 */
import type { RetroLogSearchItemTemplateType } from './retroLogSearchItemTemplateType';

export interface RetroLogSearchItem {
    id?: string;
    /** @nullable */
    daily_log_id?: string | null;
    retro_date?: string;
    template_type?: RetroLogSearchItemTemplateType;
    /** 검색어 앞뒤 50자 */
