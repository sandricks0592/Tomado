...
export type RetroLogSearchItemTemplateType =
    (typeof RetroLogSearchItemTemplateType)[keyof typeof RetroLogSearchItemTemplateType];

export const RetroLogSearchItemTemplateType = {
    Tech: 'Tech',
    Decision: 'Decision',
