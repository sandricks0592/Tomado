...
export type CreatePomodoroSessionRequestType =
    (typeof CreatePomodoroSessionRequestType)[keyof typeof CreatePomodoroSessionRequestType];

export const CreatePomodoroSessionRequestType = {
    focus: 'focus',
