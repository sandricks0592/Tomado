...
export type CreateRetroLogRequestTemplateType =
    (typeof CreateRetroLogRequestTemplateType)[keyof typeof CreateRetroLogRequestTemplateType];

export const CreateRetroLogRequestTemplateType = {
    Tech: 'Tech',
    Decision: 'Decision',
