 ...
 */
import type { CreateRetroLogRequestContent } from './createRetroLogRequestContent';
import type { CreateRetroLogRequestTemplateType } from './createRetroLogRequestTemplateType';

export interface CreateRetroLogRequest {
    /**
     * 연관 일일 로그 ID (선택)
     * @nullable
     */
